...
object AIndexFinancialDerivative extends RegimeTask with TimeSeries {
  ...
  val saveTo         = "aindex_financial_derivative"
  val primaryKeyName = "PK_aindex_financial_derivative"
  val primaryColumn  = Seq("object_id")
  val index1         = ("IDX_aindex_financial_derivative", Seq("update_date"))
  val index2         = ("IDX_aindex_financial_derivative", Seq("report_period", "symbol"))

...
object AShareInformationWind extends Information {
  ...
  lazy val saveToCol   = connBizTableColumn("ashare_information_wind", Token.timeColumnBiz)
  lazy val primaryKey  = ("PK_ashare_information_wind", Seq(Token.objectId))
  lazy val index1      = ("IDX_ashare_information_wind_1", Seq(Token.timeColumnBiz))
  lazy val index2      = ("IDX_ashare_information_wind_2", Seq(Token.symbol))
